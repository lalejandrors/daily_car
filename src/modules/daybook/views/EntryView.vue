<template>
    ...
    <div class="d-flex flex-column px-3 h-75">
        <textarea placeholder="Cual es el auto del día?"></textarea>
    </div>

    <Fab icon="fa-save" />

    <img class="img-thumbnail" src="https://i.ytimg.com/vi/7LNfbhZ7Drc/maxresdefault.jpg" alt="entry-pircture">
</template>
